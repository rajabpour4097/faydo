...
# ─── Paths ────────────────────────────────────────────────────────────────────
PROJECT_DIR="$HOME/project/test/django/Faydo/faydo"
...
echo -e "${BLUE}🔧 راه‌اندازی Django Backend روی 0.0.0.0:8001...${NC}"
cd "$BACKEND_DIR" || error_exit "ورود به پوشه backend ممکن نیست"

python manage.py runserver 0.0.0.0:8001 > "$BACKEND_LOG" 2>&1 &
BACKEND_PID=$!
...
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
echo -e "${BLUE}🔧 Backend:${NC}  http://0.0.0.0:8001"
