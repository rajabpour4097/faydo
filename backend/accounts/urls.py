...
from .views import (
    ...
    amenity_catalog_view, business_amenities_view, business_working_hours_view,
...
urlpatterns = [
    ...
    path('auth/profile/business/amenities/', business_amenities_view, name='business_amenities'),
    path('auth/profile/business/working-hours/', business_working_hours_view, name='business_working_hours'),
    path('amenities/catalog/', amenity_catalog_view, name='amenity_catalog'),
    ...
    # QR Code endpoints
    path('qr/verify/', verify_qr_code, name='verify_qr_code'),
